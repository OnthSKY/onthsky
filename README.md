...
<div align="center">
  <img src="https://media.giphy.com/media/3o7TKtd1cd8xTtZs3O/giphy.gif" width="200" />
</div>
...
* `C#`, `.NET Core / Framework`, `RESTful APIs`, `SOLID`, `DDD`, `CQRS`
* `MediatR`, `Clean/Onion Architecture`, `Microservices`
...
* `eBA Platform`, `Form Tasarımı`, `İş Akışları`, `Entegrasyonlar`
